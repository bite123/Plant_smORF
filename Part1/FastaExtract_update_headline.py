# This script is originated from FastaExtract_update.py, and will reserve the complete headline.
...
with open(input_file) as f_in, open(output_file, "w") as f_out, open(unextracted_file, "w") as f_un:
	...
	for extract_id in extract_list:
		...
		anno_line = headline_map[extract_id]
